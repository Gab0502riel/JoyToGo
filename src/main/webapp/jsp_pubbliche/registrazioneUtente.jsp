...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/risorse/css/styleregisterutente.css">
...
<div class="navbar">
  ...
  <div class="navbar_buttons">
         <a href="<%=request.getContextPath()%>/jsp_pubbliche/registrazioneRistoratore.jsp" target="_blank">
       		 <button class="partner">Diventa Partner</button> 
        </a>
    <a href="<%=request.getContextPath()%>/jsp_pubbliche/login.jsp">
        ...
        <form class="registration_form" action="<%=request.getContextPath() %>/inserisciUtente" method="POST">
            ...
            <div>
                <p class="login_prompt">Hai già un account? <a
                        href="<%=request.getContextPath()%>/jsp_pubbliche/login.jsp">Accedi</a></p>
            </div>
        </form>
    </div>
