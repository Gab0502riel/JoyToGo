...
<meta charset="UTF-8">
 <title>Login Utente</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/risorse/css/styleloginutente.css">
   ...
   <div class="navbar">
    ...
    <div class="navbar_buttons">
        ...
        <a href="<%=request.getContextPath()%>/jsp_pubbliche/registrazioneUtente.jsp" target="_blank">
            <button class="signup_button">Registrati</button>
        </a>
    </div>
</div>
